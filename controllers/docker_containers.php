...
class DockerContainers extends Base
{
    public static $aRoutes = [
        'list_docker_containers' => ['fnGetList'],
        'update_and_list_docker_containers' => ['fnWipeAndGetList'],
        'update_list_containers' => ['fnWipe'],
    ];

    public static function fnUpdate()
    {
        $aList = Request::fnGetContainersList();

        foreach ($aList as $aItem) {
            $oContainer = R::dispense(T_DOCKER_CONTAINERS);
    ...
    {
        $aList = R::findAll(T_DOCKER_CONTAINERS);
